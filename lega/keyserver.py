...
.. note:: Example Request responses are available below and responses have similar structured content for both ``/active`` and ``/retrieve`` endpoints.
    Based on the structure below retrieving either the public or private part of a PGP/RSA key is achieved by retaining in the response either the private or the public part of the key.
